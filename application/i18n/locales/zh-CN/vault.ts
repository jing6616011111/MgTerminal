...
export const zhCNVaultMessages: Messages = {
  ...
  'hostDetails.algorithms.inheritedNotice': '当前组已设置以下分类的算法 override：{categories}。本面板的"恢复默认"只会回到组的设置，而不是 MagiesTerminal 默认列表。若要忽略组的限制，请到组的算法设置里取消。',
  ...
  'cloudSync.localBackups.desc': 'MagiesTerminal 会在版本变化前，以及恢复主机库前，自动留下一份本地恢复点。',
  'cloudSync.localBackups.retentionTitle': '备份保留数量',
  'cloudSync.localBackups.retentionDesc': '设置 MagiesTerminal 最多保留多少份本地备份。',
  ...
  'cloudSync.localBackups.unavailableDesc': '当前平台未提供受支持的安全密钥库，MagiesTerminal 无法安全地写入本地备份。请在支持系统钥匙串的环境中运行，或改用云同步保留恢复点。',
  ...
  'cloudSync.githubFlow.desc': '复制下面的 code，并在 GitHub 页面输入以授权 MagiesTerminal。',

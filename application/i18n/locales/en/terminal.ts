...
export const enTerminalMessages: Messages = {
  ...
  'terminal.osc7Setup.desc': 'MagiesTerminal will add OSC 7 prompt hooks for the current remote user. This helps SFTP follow the terminal directory after sudo or su.',
  ...
  'terminal.et.proxyUnsupported': 'EternalTerminal does not currently support MagiesTerminal proxy settings. Use SSH or remove the proxy for this host.',
  'terminal.et.multiJumpUnsupported': 'EternalTerminal currently supports at most one jump host in MagiesTerminal.',
  ...
  'cloudSync.strategy.smartMergeDesc': 'Combine changes from both sides when possible; if MagiesTerminal cannot decide safely, ask you to choose.',
  ...
  'cloudSync.localBackups.desc': 'MagiesTerminal keeps local restore points before app version changes and before vault restores.',
  'cloudSync.localBackups.retentionTitle': 'Backup Retention',
  'cloudSync.localBackups.retentionDesc': 'Choose how many local backups MagiesTerminal should keep.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'This platform does not expose a secure keychain to MagiesTerminal, so local backups cannot be written safely. Install MagiesTerminal on a system with a supported keychain to enable the local backup history.',
  ...
  'cloudSync.githubFlow.desc': 'Copy the code below and enter it on GitHub to authorize MagiesTerminal.',
  ...
  'snippets.import.toast.invalidDesc': 'This is not a valid MagiesTerminal snippets file.',
  ...
  'snippets.import.modal.desc': 'Choose one or more MagiesTerminal snippets JSON files. MagiesTerminal will preview them before anything is imported.',

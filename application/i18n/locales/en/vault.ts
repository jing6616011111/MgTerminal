...
export const enVaultMessages: Messages = {
  ...
  'pf.type.dynamic.desc': 'Dynamic port forwarding turns MagiesTerminal into a SOCKS proxy server.',
  ...
  'settings.sshDeepLink.enable': 'Open ssh:// and telnet:// links with MagiesTerminal',
  'settings.sshDeepLink.enableDesc': 'Allow MagiesTerminal to handle ssh:// and telnet:// links from browsers and other apps.',
  'settings.jmsDeepLink.title': 'JumpServer Links',
  'settings.jmsDeepLink.enable': 'Handle jms:// links',
  'settings.jmsDeepLink.enableDesc': 'Register MagiesTerminal as the handler for JumpServer jms:// client links. May conflict with the official JumpServer client.',
  ...
  'hostDetails.algorithms.inheritedNotice': 'The current group has algorithm overrides set for: {categories}. The "Reset" button here falls back to the group\'s lists, not MagiesTerminal\'s defaults. To ignore the group restriction, clear the override in the group\'s algorithm settings.',

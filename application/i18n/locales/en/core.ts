...
export const enCoreMessages: Messages = {
  ...
  'settings.update.hint': 'MagiesTerminal checks for updates from GitHub Releases.',
  ...
  'settings.appearance.appIcon.desc': 'Choose a dock/taskbar icon style to make MagiesTerminal easier to spot when switching apps. Applies at runtime; the installed app bundle icon is unchanged.',

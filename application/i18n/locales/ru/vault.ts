...
export const ruVaultMessages: Messages = {
  ...
  'pf.type.dynamic.desc': 'Динамический проброс портов превращает MagiesTerminal в SOCKS-прокси-сервер.',
  ...
  'settings.sshDeepLink.enable': 'Открывать ssh:// и telnet:// ссылки в MagiesTerminal',
  'settings.sshDeepLink.enableDesc': 'Разрешить MagiesTerminal обрабатывать ssh:// и telnet:// ссылки из браузеров и других приложений.',
  'settings.jmsDeepLink.title': 'Ссылки JumpServer',
  'settings.jmsDeepLink.enable': 'Обрабатывать ссылки jms://',
  'settings.jmsDeepLink.enableDesc': 'Зарегистрировать MagiesTerminal как обработчик клиентских ссылок JumpServer jms://. Может конфликтовать с официальным клиентом JumpServer.',
  ...
  'hostDetails.algorithms.inheritedNotice': 'В текущей группе заданы переопределения алгоритмов для: {categories}. Кнопка «Сбросить» здесь возвращает к спискам группы, а не к значениям MagiesTerminal по умолчанию. Чтобы игнорировать ограничение группы, очистите переопределение в настройках алгоритмов группы.',

...
export const zhTWAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': '留空時優先使用模型列表傳回的值；如果沒有，MagiesTerminal 會使用安全預設值。',
  ...
  'ai.codex.customConfigMissingEnvKey': '警告：環境變數 {envKey} 未在目前 shell 中設定。請 export 它（或從包含該變數的 shell 啟動 magiesTerminal），否則 Codex 無法完成認證。',
  ...
  'ai.externalMcp.description': '將 MagiesTerminal 作為 MCP 伺服器暴露給 Codex、Claude Code、Cursor、Grok 等外部用戶端。工具面與應用內 Agent 相同。用戶端連線期間請保持 MagiesTerminal 執行。',
  ...
  'ai.externalMcp.mode.description': '暫時模式會在閒置逾時後自動關閉；常開模式會在 MagiesTerminal 啟動時還原對外 MCP。',
  ...
  'ai.externalMcp.usage.keepRunning': '1. 開啟對外 MCP 開關，並保持 MagiesTerminal 執行。',
  ...
  'ai.externalMcp.permissionMode.hint': '與「設定 → AI → 安全」為同一項。自動：MagiesTerminal 寫入操作不再彈本應用審批；確認：每次詢問。外部用戶端（Codex / Claude / Grok）仍可能有自己的工具審批介面。',
  ...
  'ai.externalMcp.conflict.description': '已存在指向其他位置的 magiesTerminal-external 項目，請手動刪除或修改。',
  ...
  'ai.userSkills.description': '開啟 MagiesTerminal 的 Skills 資料夾以新增你自己的技能目錄。MagiesTerminal 會自動掃描這些 skills，預設只注入輕量索引，只有在請求明顯命中某個 skill 時才展開正文。',
  ...
  // AI Error
  'ai.codex.bridgeError': 'Codex 主程序處理器尚未載入。請完全重啟 MagiesTerminal 或重啟 Electron 開發程序，然後重試。',
  ...
  'ai.safety.permissionMode.description': '控制 AI 透過 MagiesTerminal 存取終端工作階段的方式。觀察者模式會阻止經由 MagiesTerminal 的寫操作；外部 Agent CLI 可能仍有自己的本機工具和審批流程。',
  ...
  'ai.safety.commandTimeout.description': '透過 MagiesTerminal 執行指令時允許執行的最長秒數，超時將被終止。',
  ...
  'ai.safety.blocklist.description': '用於攔截透過 MagiesTerminal 執行的危險指令的正規表示式。',
  ...
  'ai.safety.note': '這些安全設定會約束經由 MagiesTerminal 執行的操作。外部 Agent CLI 也可能提供本機工具，那部分由 Agent 自己的控制規則約束。',

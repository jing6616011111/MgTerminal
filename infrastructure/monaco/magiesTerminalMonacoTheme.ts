...
export interface MagiesTerminalEditorColors {
  bg: string;
  fg: string;
  primary: string;
  card: string;
...
export const getMagiesTerminalEditorColors = (isDark: boolean): MagiesTerminalEditorColors => ({
...
export const getMagiesTerminalThemeSignal = (): string => {
  if (typeof document === 'undefined' || typeof getComputedStyle === 'undefined') {
    return '';
  }
...
export const MAGIES_TERMINAL_MONACO_THEME_DARK = 'magiesTerminal-dark';
export const MAGIES_TERMINAL_MONACO_THEME_LIGHT = 'magiesTerminal-light';

export const getMagiesTerminalMonacoThemeName = (isDark: boolean): string => (
  isDark ? MAGIES_TERMINAL_MONACO_THEME_DARK : MAGIES_TERMINAL_MONACO_THEME_LIGHT
);

export const buildMagiesTerminalMonacoThemeColors = (
  colors: MagiesTerminalEditorColors,

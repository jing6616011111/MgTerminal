...
test("records aligned short commands when standard prompt echo lags by one character", () => {
  const cases = [
    ...
    { lineText: "[user@host ~]$ l", typedInput: "ls", promptText: "[user@host ~]$ " },
    { lineText: "➜  magiesTerminal $ l", typedInput: "ls", promptText: "➜  magiesTerminal $ " },
...
test("does not record themed prompt decorations when typed input is unreliable", () => {
  const cases = [
    ...
    {
      lineText: "➜  magiesTerminal git:(main) ✗ git status",
      promptText: "➜ ",
      expectedUserInput: " magiesTerminal git:(main) ✗ git status",
    },
    {
      lineText: "  ~ git status",
      promptText: " ",
...
test("records recognized themed prompts when typed input is unreliable", () => {
  const cases = [
    "➜ git status",
    " git status",
    "➜  magiesTerminal $ git status",
    "➜  magiesTerminal git:(main) ✗ $ git status",
    "  ~ $ git status",
  ];
...
test("aligns themed bare directory prompts with reliable typed input", () => {
  const cases = [
    { dir: "magiesTerminal", typedInput: "ls" },
